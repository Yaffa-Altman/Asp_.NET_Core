...
public class LoginController: ControllerBase
{
    ...
    public LoginController(IGenericService<User> userService, JsonService<User> jsonService) { 
        Log.Information("start LoginController Constructor");
        this.userService = userService;
        this.jsonService = jsonService;
        Log.Information("end LoginController Constructor");
    }
    ...
    public ActionResult<String> Login([FromBody] User user)
    {
        ...
        {
            Log.Information("in LoginController Login - user ADMIN");
        ...
        {
            Log.Information("in LoginController Login - user USER");
        ...
        Log.Information("end LoginController Login");
